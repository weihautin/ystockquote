...
"""
history = ystockquote.get_historical_prices('GOOGL', '2013-01-03', '2013-01-08')    
print history['2013-01-08']['Volume']

"""

#print ystockquote.get_historical_prices('GOOGL', '2013-01-03', '2013-01-08')['2013-01-08']['Volume']
